        ...
        try (PreparedStatement stmt = con.prepareStatement(
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                while (rs.next()) {
                    ...
                    MostrarVentas ventas = new MostrarVentas(idVenta,fecha, monto, tipo, metodoPago, estPago, ncliente, numC);
        ...
        try (PreparedStatement stmt = con.prepareStatement(
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                while (rs.next()) {
                    ...
                    venta = new MostrarVentas(idVenta,fecha, monto, tipo, metodoPago, estPago, ncliente, numC);
