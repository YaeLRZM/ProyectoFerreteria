...
public class Ingresos extends javax.swing.JFrame {
    ...
    try {
        ReporteVentas reporte = new ReporteVentas();
        Map<String, Double> ventasPorFecha = ReporteVentas.obtenerTotalVentasPorDiaMes(); // formato clave: "2025-04-06"

        // Mapa para almacenar fechas parseadas y ordenarlas cronológicamente
        ...
        for (Map.Entry<LocalDate, Double> entry : ventasOrdenadas.entrySet()) {
            ...
            String etiqueta = diaSemana.substring(0, 1).toUpperCase() + diaSemana.substring(1) + " - " + fecha.getDayOfMonth();
        ...
        // Crear gráfico
        JFreeChart graficoBarras = ChartFactory.createBarChart(
            "Total de Ventas del Mes de " + obtenerMesActualEnTexto(), // <- opcional: cambia "Abril 2025" dinámicamente
            "Fecha",
            "Total de Ventas - $",
            dataset,
            PlotOrientation.VERTICAL,
...
private String capitalizar(String texto) {
    ...
    private void initComponents() {
        ...
        jPanel4.add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(24, 6, 28, 50));

        jTextField1.setBackground(new java.awt.Color(204, 204, 204));
        jTextField1.setFont(new java.awt.Font("Ebrima", 0, 17)); // NOI18N
        ...
        jPanel4.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, 315, 38));

        jLabel3.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        jLabel3.setText("Ingresos");
        jPanel4.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 40, -1, -1));
        ...
        jPanel4.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(391, 7, 575, 27));
