...
public class Ventas extends javax.swing.JFrame {
    ...
    public Ventas() {
        ...
        TablaVentas.getColumnModel().getColumn(7).setWidth(0);
    ...
    private void ordenarTabla(DefaultTableModel modelo){
        ...
        orden.add(new RowSorter.SortKey(4, SortOrder.ASCENDING));
    ...
    private void initComponents() {
        ...
        TablaVentas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fecha", "MontoTotal", "Tipo", "Forma de Pago", "Estado de pago", "Cliente", "Numero de Cliente", "Title 8"
            }
        ) {
...
if (filaSeleccionada != -1) { 
    Object idVenta = TablaVentas.getValueAt(filaSeleccionada, 7);
...
if (filaSeleccionada != -1) { 
    Object estado = TablaVentas.getValueAt(filaSeleccionada, 4);
    Object idV = TablaVentas.getValueAt(filaSeleccionada, 7);
